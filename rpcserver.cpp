...
void StartRPCThreads()
{
         ...
         (mapArgs["-rpcuser"] == mapArgs["-rpcpassword"])) && Params().RequireRPCPassword())
    {
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
            _("To use pepesd, or the -server option to pepes-qt, you must set an rpcpassword in the configuration file:\n"
              "%s\n"
              ...
              "for example: alertnotify=echo %%s | mail -s \"pepes Alert\" admin@foo.com\n"),
...
std::string HelpExampleCli(string methodname, string args){
    return "> pepes-cli " + methodname + " " + args + "\n";
}
