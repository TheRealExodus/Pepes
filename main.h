...
/** pepes: Dust Threshold: outputs below this value in satoshis are assessed an additional 1000 bytes per txout */
static const CAmount DUST_THRESHOLD = 100000; // 0.001 LTC
/** pepes: Default TX Fee per 1000 bytes */
static const CAmount DEFAULT_TX_FEE = 100000; // 0.001 LTC

/** pepes: default minimum input threshold, override with -mininput */
