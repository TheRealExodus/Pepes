...
public:
    CMainParams() {
        ...
        vSeeds.push_back(CDNSSeedData("pepestools.com", "dnsseed.pepestools.com"));
        vSeeds.push_back(CDNSSeedData("pepespool.org", "dnsseed.pepespool.org"));
        ...
        vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-a.pepes.loshan.co.uk"));
        ...
        // pepes: Mainnet v2 enforced as of block 710k
...
public:
    CTestNetParams() {
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("pepestools.com", "testnet-seed.pepestools.com"));
        ...
        // pepes: Testnet v2 enforced as of block 400k
...
public:
    CRegTestParams() {
        ...
        // pepes: v2 enforced using Bitcoin's supermajority rule
