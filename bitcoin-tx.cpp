...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("pepes Core pepes-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  pepes-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded pepes transaction") + "\n" +
              "  pepes-tx [options] -create [commands]   " + _("Create hex-encoded pepes transaction") + "\n" +
              "\n";
