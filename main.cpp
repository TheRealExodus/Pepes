...
#if defined(NDEBUG)
# error "pepes cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "pepes Signed Message:\n";
...
bool ContextualCheckBlockHeader(const CBlockHeader& block, CValidationState& state, CBlockIndex * const pindexPrev)
{
    ...
    // pepes: Reject block.nVersion=1 blocks (mainnet >= 710000, testnet >= 400000, regtest uses supermajority)
...
bool ContextualCheckBlock(const CBlock& block, CValidationState& state, CBlockIndex * const pindexPrev)
{
    ...
    // pepes: (mainnet >= 710000, testnet >= 400000, regtest uses supermajority)
